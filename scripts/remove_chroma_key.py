...
移植自 OpenAI Codex 项目自带的 imagegen sample skill：
https://github.com/openai/codex/tree/main/codex-rs/skills/src/assets/samples/imagegen
原始版权归 OpenAI 所有，依据 Apache License 2.0 授权，本文件除本说明外未做逻辑修改。

当前 imagegen skill 的 v1 版本暂未接入这个脚本到主流程，留作以后需要
透明背景素材(chroma-key 抠图转 alpha 通道)时使用，用法见 --help。
需要 Pillow: pip install pillow

This helper supports a transparent-image workflow: generate an image on a
